...
formulario.addEventListener("submit", function (e) {
    ...
    var bolError = false;
    var alerta = new bootstrap.Modal(document.getElementById('alerta_validar'));

    var user = document.getElementById('username').value.trim();
    var passwd = document.getElementById('passwd').value.trim();
    var conf_contrasena = document.getElementById('conf_contrasena').value.trim();
